...
VOC_CLASSES_mask = (  # always index 0
    'face', 'face_mask')

# note: if you used our download scripts, this should be right
path_to_dir = osp.dirname(osp.abspath(__file__))
VOC_ROOT_mask = path_to_dir + "/VOCdevkit/"

VOC_ROOT_mask = "/home/zldlg/yolov2-yolov3_PyTorch/dataset/VOC/VOCdevkit/"


class VOCAnnotationTransform_mask(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(VOC_CLASSES_mask, range(len(VOC_CLASSES_mask))))
...
class VOCDetection_mask(data.Dataset):
    ...
    def __init__(self, root,
                 ...
                 transform=None, target_transform=VOCAnnotationTransform_mask(),
                 dataset_name='Mask'):
        self.root = root
