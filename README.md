...
python train.py -d mask --cuda -v slim_yolo_v2       #可以优化成在此再直接进行quantize
python conv+bn2conv.py -d mask --cuda -v slim_yolo_v2 -r ....
python retune.py -d mask --cuda -v slim_yolo_v2_q_bf -r ....
python retune_bias_quantize.py -d mask --cuda -v slim_yolo_v2_q_bf -q -r ....
python retune_bias_quantize_findbest.py -d mask --cuda -v slim_yolo_v2_q_bf -q -r ...

python retune_bias_quantize_findbest.py -d mask --cuda -v slim_yolo_v2_q_bf -r /home/zldlg/yolov2-yolov3_PyTorch/correct/yolov2-yolov3_PyTorch-master/weights/mask/new_bak/slim_yolo_v2_q_bf_retune_quantize_test3.pth -q
```
